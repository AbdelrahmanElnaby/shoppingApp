...
class Orders{
    ...
    public async addProduct(order_id:number,order_products:Order_Products):Promise<Order_Products>{
        const{
            product_id,
            quantity
        }=order_products;
    ...
    public async deleteOrderProducts(id:number):Promise<Order_Products>{
